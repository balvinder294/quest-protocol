...
/**
 * QUEST PROTOCOL | MONGODB CLUSTER NODE v1.9.14
 * ROBUST ED25519 CONSENSUS + ENV CONFIG SUPPORT
 */
...
async function initMongo() {
    try {
        ...
        console.log(`[NODE] Quest Protocol v1.9.14 [ENV_LOADED]: @${CONFIG.WITNESS_NAME}`);
    } catch (e) {
